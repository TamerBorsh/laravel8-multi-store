...
<html lang="en">
    <head>
        ...
        @if (LaravelLocalization::getCurrentLocaleDirection() == 'rtl')<link href="{{asset('backend/assets/css/ar.min.css')}}" rel="stylesheet" type="text/css">@endif
        @yield('stylesheet')
    </head>
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        ...
        <div class="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                <!-- Topbar Start -->
                @include('back.layouts.header')<!-- end Topbar -->
        ...
        <script src="{{asset('backend/js/sweetalert2/sweetalert2.min.js')}}"></script>
        @yield('script')
