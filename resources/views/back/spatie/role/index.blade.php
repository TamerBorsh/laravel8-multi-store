                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="card-block">
                                <button type="button" class="btn btn-success btn-outline-default waves-effect md-trigger" data-modal="modal-add">Add Role</button>
                            </div>                 
                        </div>
                        {{-- =========Button========= --}}
                        <div class="card-block">
                                ...
                                <table class="table table-de">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('roles.show', $role->id)}}" class="btn btn-warning"style="padding: 5px;">{{$role->permissions_count}} : permissions</a></td>
                                            <td data-id="{{$role->id}}" class="text-center">
                                                <a class="btn btn-sm btn-info text-light waves-effect md-trigger" id="editRow" data-id="{{$role->id}}" data-modal="modal-edit" style=" padding: 6px 10px; "><span class="icofont icofont-ui-edit"></span></a>
                                                <a class="btn btn-sm btn-danger text-light"  id="deleteRow" data-id="{{$role->id}}" style=" padding: 6px 10px; "><span class="icofont icofont-ui-delete"></span></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                ...
                                <div>
                                    ...
                                    <form id="addNewDataForm">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="select" class="form-control" id="role">
                                ...
                                <div>
                                    ...
                                    <form id="editDataForm">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="select" class="form-control" id="e_role">
                                                    <option value="user">User</option>
                                                    <option value="seller">Seller</option>
                                                    <option value="admin">Admin</option>
                                                </select>
...
<script>
    ...
    $('body').on('click','#editRow',function(){
        let id = $(this).data('id');
        let edit = '/'+ window.location.pathname.split('/')[1] +'/dashboard/roles/'+ id + '/edit';
        axios.get(edit)
        .then(function(res){
            // console.log(res);
    ...
    $('body').on('submit','#editDataForm',function(e){
        e.preventDefault()
        let id = $('#e_id').val()
        axios.put('/'+ window.location.pathname.split('/')[1] +'/dashboard/roles/'+ id, {
            name: $('#e_name').val(),
            guard_name: $('#e_role').val(),
        }).then(function (response) {
            toastr.success(response.data.message);
            window.location.href = location.href
        })
